...
public class ButterfluyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] gridViewString = {
                "Acraea Violae","Cethosia Cyane","Danaus Chrysippus","Graphium Agamemnon","Hypolimnas Bolina","Pachiliopta Aristolochiae","Papilio Demoleus","Papilio Memnon","Parthenos Slyvia"

        } ;

        int[] gridViewImageId = {
                R.drawable.acraeaviolae, R.drawable.cethosiacyane, R.drawable.danauschry,
        ...
        final String[] gridViewStringDesc = {
